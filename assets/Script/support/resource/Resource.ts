...
export default class Resource {
    ...
    load(resources: string | string[] | { uuid?: string; url?: string; type?: string }, callback?: Function) {
        if (!resources) {
            cc.log("参数错误");
            return;
        }
    ...
    loadRes(url: string, callback: Function): void {
        if (!url || !callback) {
            cc.log("参数错误");
            return;
        }
    ...
    loadResArr(paths: Array<string>, callback: Function) {
    ...
    loadResDir(url: string, progressCallback: any, callback: any) {
        cc.loader.loadResDir(url, progressCallback, function (err, assets) {
    ...
    // loadStaticResArr(paths: Array<string>, tag: string, callback: Function) {
    //     if (!paths || !tag || !callback) {
    //         cc.log("参数错误");
    //         return;
    //     }
    ...
    // loadAudioClip(path: string, callback) {
    ...
    // loadSpriteFrame(path: string, callback: Function, retainRes: boolean = false) {
    ...
    // loadSpriteFrames(paths: Array<string>, callback: Function, retainRes: boolean = false) {
